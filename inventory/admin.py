...
class ColorInline(admin.TabularInline):
    model = SubPart.colors.through  # Using the through model for ManyToMany relationship
    extra = 1
    fields = ('color',)  # This will be a dropdown of colors
...
class SubPartAdmin(admin.ModelAdmin):
    list_display = ('name',)
    inlines = [SubPartRawMaterialInline, ColorInline]  # Add ColorInline here
